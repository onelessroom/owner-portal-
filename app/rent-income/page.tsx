...
import RentIncomeAccordion from '@/components/RentIncomeAccordion'
...
export default async function RentIncomePage() {
  ...
  const { data: rooms } = await supabase
    .from('rooms')
    .select('id, property_id, room_number, rent_amount, status')
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      <header className="bg-white border-b border-gray-100 px-4 py-3 flex items-center gap-3 sticky top-0 z-10">
        ...
        <h1 className="font-bold text-gray-900 text-base">家賃収入の内訳</h1>
      </header>
      ...
      <main className="max-w-lg mx-auto px-4 pt-5 space-y-4">
        ...
        <div className="bg-blue-600 rounded-2xl p-5 text-white shadow-lg">
          <p className="text-sm font-medium opacity-80">{year}年{month}月　家賃収入 合計</p>
        ...
        {/* 物件別アコーディオン */}
        <RentIncomeAccordion properties={propertiesWithRooms} />
